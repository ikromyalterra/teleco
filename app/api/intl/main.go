...
import (
	...
	"github.com/sepulsa/teleco/api/intl/v1/routes"
	...
	_ "github.com/sepulsa/teleco/app/api/intl/docs/v1"
	echoSwagger "github.com/swaggo/echo-swagger"
)

// @title Teleco Internal API
// @version 1.0
// @description REST API for internal dashboard
// @termsOfService http://swagger.io/terms/

// @contact.name Teleco
// @contact.url https://teleco-dev-intl.sumpahpalapa.com/
...
// @schemes https
// @host teleco-dev-intl.sumpahpalapa.com
// @BasePath /api/v1
func main() {
